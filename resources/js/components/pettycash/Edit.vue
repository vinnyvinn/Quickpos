            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edit Pettycash</h4>
                    </div>
                    <div class="card-body">
                        <form @submit.prevent="updatePettyCash">
...
<script>
    export default {
        ...
        methods:{
            ...
            getPettyCash(){
                axios.get('petty-cash/'+this.$route.params.id)
                    .then(res => {
                            this.form.name = res.data.name,
                            this.form.petty_cash_id  = res.data.petty_cash_id,
            ...
            updatePettyCash(){
                let items = {
                  name: this.form.name,
                    petty_cash_id: this.form.petty_cash_id,
                    amount: this.form.amount,
                    id: this.$route.params.id
                };
                axios.post('update-petty-cash',items)
